...
function ContactForm() {
    return (
        <div >
            <NavBar/>
            <h1 className='font-bold text-6xl text-center pt-20'>Contact Us</h1>
        <div className=" relative flex items-top justify-center  bg-white dark:bg-gray-900 pt-5 pb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 ">
                        ...
                        <form className="p-6 flex flex-col justify-center">
                            <div className="flex flex-col">
                                ...
                                <input type="text" name="name" id="name" placeholder="Full Name" className="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none" />
                            </div>
